...
class BatchGenerator(object):
    def __init__(self, dataframe, dataproperties, training, batch_size=16, model_input_type="text"):
        self.training_data = training
        self.model_input_type = model_input_type ##text
        # self.aubio = False
    ...
    def get_batch(self, idx):
        ...
        # 1. X_data (the featuress for the batch)
